...
(function() {
 ...
 loadPackage({
  "files": [ {
   "filename": "/vfs/pumpkin.lua",
   "start": 0,
   "end": 377
  }, {
   "filename": "/vfs/app_install/MINEHUNT.PRC",
   "start": 377,
   "end": 8665
  }, {
   "filename": "/vfs/app_install/BOOT.prc",
   "start": 8665,
   "end": 310442
  }, {
   "filename": "/vfs/app_install/Launcher.prc",
   "start": 310442,
   "end": 326907
  }, {
   "filename": "/vfs/app_install/.empty",
   "start": 326907,
   "end": 326907
  } ],
  "remote_package_size": 326907,
  "package_uuid": "7846508e-f423-4e6a-aaef-b7a035c8ea7a"
 });
})();
...
var PThread = {
 ...
 allocateUnusedWorker: function() {
  var pthreadMainJs = locateFile("pumpkin.worker.js");
...
function ___syscall_ftruncate64(fd, low, high) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(10, 1, fd, low, high);
 try {
...
function ___syscall_open(path, flags, varargs) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(18, 1, path, flags, varargs);
 SYSCALLS.varargs = varargs;
 try {
...
function _tzset_impl(timezone, daylight, tzname) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(27, 1, timezone, daylight, tzname);
...
function _eglBindAPI(api) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(28, 1, api);
 if (api == 12448) {
  EGL.setErrorCode(12288);
  return 1;
 } else {
...
function _eglChooseConfig(display, attrib_list, configs, config_size, numConfigs) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(29, 1, display, attrib_list, configs, config_size, numConfigs);
...
function _eglCreateContext(display, config, hmm, contextAttribs) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(30, 1, display, config, hmm, contextAttribs);
 if (display != 62e3) {
  EGL.setErrorCode(12296);
  return 0;
 }
...
function _eglCreateWindowSurface(display, config, win, attrib_list) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(31, 1, display, config, win, attrib_list);
 if (display != 62e3) {
  EGL.setErrorCode(12296);
  return 0;
 }
...
function _eglDestroyContext(display, context) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(32, 1, display, context);
 if (display != 62e3) {
  EGL.setErrorCode(12296);
  return 0;
 }
...
function _eglDestroySurface(display, surface) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(33, 1, display, surface);
 if (display != 62e3) {
  EGL.setErrorCode(12296);
  return 0;
 }
...
function _eglGetConfigAttrib(display, config, attribute, value) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(34, 1, display, config, attribute, value);
 if (display != 62e3) {
  EGL.setErrorCode(12296);
  return 0;
 }
...
function _eglGetDisplay(nativeDisplayType) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(35, 1, nativeDisplayType);
 EGL.setErrorCode(12288);
 return 62e3;
}
...
function _eglInitialize(display, majorVersion, minorVersion) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(37, 1, display, majorVersion, minorVersion);
 if (display == 62e3) {
  if (majorVersion) {
...
function _eglMakeCurrent(display, draw, read, context) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(38, 1, display, draw, read, context);
 if (display != 62e3) {
  EGL.setErrorCode(12296);
  return 0;
 }
...
function _eglQueryString(display, name) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(39, 1, display, name);
 if (display != 62e3) {
  EGL.setErrorCode(12296);
  return 0;
 }
...
function _eglSwapInterval(display, interval) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(41, 1, display, interval);
 if (display != 62e3) {
  EGL.setErrorCode(12296);
  return 0;
 }
...
function _eglTerminate(display) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(42, 1, display);
 if (display != 62e3) {
  EGL.setErrorCode(12296);
  return 0;
 }
...
function _eglWaitNative(nativeEngineId) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(44, 1, nativeEngineId);
 EGL.setErrorCode(12288);
 return 1;
}
...
function _emscripten_force_exit(status) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(49, 1, status);
 noExitRuntime = false;
...
function _emscripten_get_element_css_size(target, width, height) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(51, 1, target, width, height);
...
function _emscripten_get_gamepad_status(index, gamepadState) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(52, 1, index, gamepadState);
...
function _emscripten_get_screen_size(width, height) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(54, 1, width, height);
...
function _emscripten_request_fullscreen_strategy(target, deferUntilInEventHandler, fullscreenStrategy) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(55, 1, target, deferUntilInEventHandler, fullscreenStrategy);
 var strategy = {
...
function _emscripten_request_pointerlock(target, deferUntilInEventHandler) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(56, 1, target, deferUntilInEventHandler);
 target = findEventTarget(target);
 if (!target) return -4;
...
function _emscripten_set_beforeunload_callback_on_thread(userData, callbackfunc, targetThread) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(58, 1, userData, callbackfunc, targetThread);
...
function _emscripten_set_element_css_size(target, width, height) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(60, 1, target, width, height);
 target = findEventTarget(target);
 if (!target) return -4;
...
function _emscripten_set_gamepadconnected_callback_on_thread(userData, useCapture, callbackfunc, targetThread) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(63, 1, userData, useCapture, callbackfunc, targetThread);
...
function _emscripten_set_window_title(title) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(81, 1, title);
...
function _environ_get(__environ, environ_buf) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(82, 1, __environ, environ_buf);
 var bufSize = 0;
...
function _environ_sizes_get(penviron_count, penviron_buf_size) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(83, 1, penviron_count, penviron_buf_size);
...
function _fd_seek(fd, offset_low, offset_high, whence, newOffset) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(86, 1, fd, offset_low, offset_high, whence, newOffset);
 try {
  var stream = SYSCALLS.getStreamFromFD(fd);
...
function _getaddrinfo(node, service, hint, out) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(88, 1, node, service, hint, out);
 var addrs = [];
 var canon = null;
 var addr = 0;
 var port = 0;
...
var _cmain = Module["_cmain"] = createExportWrapper("cmain");
...
var _pumpkin_send_deploy = Module["_pumpkin_send_deploy"] = createExportWrapper("pumpkin_send_deploy");

var _mmuDump = Module["_mmuDump"] = createExportWrapper("mmuDump");

var _saveSetjmp = Module["_saveSetjmp"] = createExportWrapper("saveSetjmp");

var _cexit = Module["_cexit"] = createExportWrapper("cexit");
...
var __emscripten_allow_main_runtime_queued_calls = Module["__emscripten_allow_main_runtime_queued_calls"] = 457696;
